...
//control points which control the curvature
...
void display(void) {
	...
	//evaluating the intermediate points
	...
	//displaying the connection dots with different colors and size
	glPointSize(5.0);
	glColor3f(1.0, 1.0, 0.0);
	glBegin(GL_POINTS);
	for (int i = 0;i < 6;i++)
		//drawing the control points from the array
